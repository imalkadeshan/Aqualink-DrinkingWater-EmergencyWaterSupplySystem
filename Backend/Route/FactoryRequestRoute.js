...
// Get available products from factory inventory (Branch Manager)
// router.get('/available-products', authenticateToken, requireRole(['Branch Manager']), getAvailableProducts);
