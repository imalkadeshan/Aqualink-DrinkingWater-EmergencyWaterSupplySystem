...
router.post("/register", profileUpload.single('profilePicture'), UserController.registerUser);
...
router.put("/own-profile", authenticateToken, profileUpload.single('profilePicture'), UserController.updateOwnProfile);
