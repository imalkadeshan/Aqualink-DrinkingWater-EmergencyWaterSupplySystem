...
const registerUser = async (req, res) => {
    try {
        ...
        console.log('Registration - profilePicture from body:', profilePicture);
        
        if (req.file) {
            // File was uploaded, use the file path
            userData.profilePicture = `/profile-pictures/${req.file.filename}`;
            console.log('Profile picture file uploaded:', req.file.filename);
            console.log('Profile picture path set to:', userData.profilePicture);
        } else if (profilePicture) {
            // Profile picture provided as URL (for future use)
            userData.profilePicture = profilePicture;
            console.log('Profile picture URL provided:', profilePicture);
        } else {
        ...
        console.log('User saved with profilePicture:', newUser.profilePicture);
...
const updateOwnProfile = async (req, res) => {
    try {
        ...
        console.log('Update profile - body data:', { 
            name, 
            email, 
            phone, 
            address, 
        ...
        if (brigadeName) updateData.brigadeName = brigadeName;
        if (brigadeLocation) updateData.brigadeLocation = brigadeLocation;
        if (emergencyContact) updateData.emergencyContact = emergencyContact;
        if (emergencyPhone) updateData.emergencyPhone = emergencyPhone;

        // Handle profile picture upload
        if (req.file) {
            updateData.profilePicture = `/profile-pictures/${req.file.filename}`;
