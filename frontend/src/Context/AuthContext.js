...
export const AuthProvider = ({ children }) => {
    ...
    const register = async (userData) => {
        try {
            ...
            const response = await axios.post('http://localhost:5000/auth/register', userData, config);
    ...
    const deleteProfile = async () => {
        try {
            const response = await axios.delete('http://localhost:5000/auth/own-profile');
