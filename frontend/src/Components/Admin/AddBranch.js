...
const AddBranch = () => {
  ...
  const handleInputChange = (e) => {
    ...
    } else if (name === 'emergencyName' || name === 'emergencyPhone' || name === 'emergencyEmail') {
      const fieldName = name.replace('emergency', '').toLowerCase();
      setFormData(prev => ({
        ...prev,
        emergencyContact: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Prepare branch data for API - flatten contactInfo to avoid nested object issues
      const branchData = {
        name: formData.name,
        ...
        // Flatten contactInfo fields to top level
      ...
      console.log('Branch data structure:', JSON.stringify(branchData, null, 2));
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  {['Water Supply', 'Filter Sales', 'Recycling', 'Emergency Support'].map((service) => (
