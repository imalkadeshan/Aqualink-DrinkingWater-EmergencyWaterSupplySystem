...
export const generateFactoryOrdersReportPDF = async (factoryRequests, collectionRequests) => {
  ...
  doc.text('AQL', 27, 22, { align: 'center' });
  
  // Company Name and Title
  doc.setFontSize(26);
  doc.setTextColor(255, 255, 255);
  doc.text('AquaLink', 50, 20);
  doc.setFontSize(16);
  doc.text('Factory Orders Management Report', 50, 28);
  ...
  doc.text(`Report ID: FL-${Date.now().toString().slice(-6)}`, 150, 28);
  
  // Executive Summary Section
  doc.setFillColor(248, 250, 252); // Light gray background
  doc.rect(15, 50, 180, 55, 'F');
  ...
  doc.setFontSize(12);
  doc.setTextColor(255, 255, 255);
  doc.text('Factory Requests', startX + 3, startY + 10);
  doc.setFontSize(20);
  doc.text(factoryRequests.length.toString(), startX + 3, startY + 22);
  ...
  doc.setFontSize(12);
  doc.setTextColor(255, 255, 255);
  doc.text('Collection Requests', startX + cardWidth + 8, startY + 10);
  doc.setFontSize(20);
  doc.text(collectionRequests.length.toString(), startX + cardWidth + 8, startY + 22);
  ...
  doc.setFontSize(12);
  doc.setTextColor(255, 255, 255);
  doc.text('Pending', startX + (cardWidth + 5) * 2 + 3, startY + 10);
  doc.setFontSize(20);
  doc.text(pendingCount.toString(), startX + (cardWidth + 5) * 2 + 3, startY + 22);
  ...
  if (collectionRequests.length > 0) {
    ...
    doc.setFontSize(18);
    doc.setTextColor(17, 24, 39);
    doc.text('Collection Requests', 20, 25);
  ...
  doc.setFontSize(18);
  doc.setTextColor(17, 24, 39);
  doc.text('Approval and Authorization', 20, 25);
  
  // Signature areas
  doc.setFontSize(12);
  doc.setTextColor(107, 114, 128);
  doc.text('Factory Manager Approval:', 20, 50);
  
  // Signature line for Factory Manager
  doc.setDrawColor(107, 114, 128);
  doc.setLineWidth(0.5);
  doc.line(20, 60, 100, 60);
  doc.setFontSize(10);
  doc.text('Factory Manager Signature', 20, 65);
  doc.text('Date: _______________', 20, 70);
  
  // Additional signature area
  doc.setFontSize(12);
  doc.text('Quality Control Approval:', 20, 90);
  doc.line(20, 100, 100, 100);
  doc.setFontSize(10);
  doc.text('Quality Control Manager Signature', 20, 105);
  doc.text('Date: _______________', 20, 110);
  
  // Company stamp area
  doc.setFontSize(12);
  doc.text('Company Stamp:', 120, 50);
  doc.setDrawColor(34, 197, 94);
  doc.setLineWidth(1);
  doc.rect(120, 55, 60, 40);
  doc.setFontSize(8);
  doc.setTextColor(107, 114, 128);
  doc.text('Official Stamp', 140, 75, { align: 'center' });
  doc.text('AquaLink Factory', 140, 80, { align: 'center' });
